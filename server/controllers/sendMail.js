...
const sendEmail = (to, url, txt) => {
  ...
  const mailOptions = {
    ...
    html: `
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">CHÀO MỪNG BẠN ĐẾN VỚI MINH ĐỨC SHOP</h2>
            <p>Xin chúc mừng! Bạn sắp bắt đầu sử dụng Minh Đức Shop. Chỉ cần nhấp vào nút bên dưới để xác thực địa chỉ email của bạn.</p>
